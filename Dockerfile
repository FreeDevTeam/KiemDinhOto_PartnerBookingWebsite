...
ARG REACT_APP_URL_WEB_PAYMENT=${REACT_APP_URL_WEB_PAYMENT}
ENV REACT_APP_URL_WEB_PAYMENT=${REACT_APP_URL_WEB_PAYMENT}
...
ARG REACT_APP_ENABLE_PAYMENT_BOOKING_SERVICE=${REACT_APP_ENABLE_PAYMENT_BOOKING_SERVICE}
ENV REACT_APP_ENABLE_PAYMENT_BOOKING_SERVICE=${REACT_APP_ENABLE_PAYMENT_BOOKING_SERVICE}
