...
- when using environment variables in the project

## Rules

- environment variables must have initial values to avoid errors when running the project on local or deploying to production